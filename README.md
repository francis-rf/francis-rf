...
- 🔭 Associate Engineer transitioning into **AI/LLM Application Development**
...
- ⌨️ Always spells `function` as `fnuction`
...
![Anthropic](https://img.shields.io/badge/Anthropic-Claude-191919?style=for-the-badge&logoColor=white)
...
| 📄 [RAG Document Q&A](https://github.com/francis-rf/RAG-document-qa) | LangGraph + FAISS RAG system with ReAct agent workflow & web search fallback | LangGraph • LangChain • FAISS • FastAPI | [![Live Demo](https://img.shields.io/badge/Live-AWS_ELB-orange?logo=amazonaws)](http://rag-alb-1726979633.us-east-1.elb.amazonaws.com/) [![CI/CD](https://github.com/francis-rf/RAG-document-qa/actions/workflows/deploy.yml/badge.svg)](https://github.com/francis-rf/RAG-document-qa/actions/workflows/deploy.yml) |
...
| 📚 [Study Tools MCP Server](https://github.com/francis-rf/study-tools-mcp-server) | AI study assistant MCP server for Claude Desktop with quizzes & flashcards | MCP • FastAPI • OpenAI • PyMuPDF | [![Live Demo](https://img.shields.io/badge/Live-AWS_EC2-orange?logo=amazonaws)](http://3.230.151.202:8080/) [![CI/CD](https://github.com/francis-rf/study-tools-mcp-server/actions/workflows/deploy.yml/badge.svg)](https://github.com/francis-rf/study-tools-mcp-server/actions/workflows/deploy.yml) |
| ❓ [FAQ Bedrock AgentCore](https://github.com/francis-rf/faq-bedrock-agentcore) | FAQ agent for Lauki Phones covering plans, billing & device support, deployed on AWS Bedrock AgentCore | LangGraph • FastAPI • AWS Bedrock • Groq | [![Live Demo](https://img.shields.io/badge/Live-AWS_App_Runner-orange?logo=amazonaws)](https://vbfapqsnrw.us-east-1.awsapprunner.com/) [![CI/CD](https://github.com/francis-rf/faq-bedrock-agentcore/actions/workflows/deploy.yml/badge.svg)](https://github.com/francis-rf/faq-bedrock-agentcore/actions/workflows/deploy.yml) |
...
[![Website](https://img.shields.io/badge/Website-000000?style=for-the-badge&logo=googlechrome&logoColor=white)](https://francis-rf.vercel.app/)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:rfrancis789@gmail.com)

</div>

## 📈 Activity Graph

[![Francis's github activity graph](https://github-readme-activity-graph.vercel.app/graph?username=francis-rf&theme=react-dark&hide_border=true)](https://github.com/ashutosh00710/github-readme-activity-graph)
